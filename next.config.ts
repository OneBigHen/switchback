...
const SECURITY_HEADERS: Array<{ key: string; value: string }> = [
  ...
  { key: "Permissions-Policy", value: "geolocation=(self), microphone=(self), camera=(), payment=()" },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://tiles.openfreemap.org https://tiles.mapterhorn.com https://tile.opentopomap.org https://server.arcgisonline.com https://basemap.nationalmap.gov",
      "font-src 'self' data:",
      "connect-src 'self' https://tiles.openfreemap.org https://tiles.mapterhorn.com https://tile.opentopomap.org https://server.arcgisonline.com https://basemap.nationalmap.gov https://api.mapbox.com https://events.mapbox.com",
