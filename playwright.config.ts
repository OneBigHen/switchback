...
const criticalMainMatch = /\/e2e\/critical\/(planner-journeys|navigation-ia|planner-surface-composition|sketch-recovery|route-details-identity|community-routes|origin-authority|route-library-ownership|adaptive-workspace|recon)\.spec\.ts$/
