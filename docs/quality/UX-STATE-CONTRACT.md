...
construction seams and markers defined here are what visual and E2E evidence
are pinned against. Consumed by `tests/e2e/helpers/ux-state-fixtures.ts` and
`tests/e2e/visual/ux-states.spec.ts`.

Originally written as the CINCO Phase 0 contract (baseline main
`b2d78ca5267e7995a0bc9a9520e90a0e46aa4a5f`); moved here on 2026-09-08 when the
superseded CINCO roadmap was removed, because the contract itself is still
live.
