    ...
    return (
        <nav className="recon-picker" aria-label="Recon tracks">
            ...
            {journalState === "loading" ? (
                ...
                <p className="recon-quiet-note">
                    No recorded rides yet. Record a ride and Recon will bring it
                    back to life.
                </p>
            ) : (
            ...
            {journalState === "ready" && journalRejectedCount > 0 ? (
                <p className="recon-quiet-note">
                    ...
                    {journalRejectedCount === 1 ? "entry" : "entries"} could not
                    be read (unreadable geometry or timestamps) and{" "}
            ...
            {catalogUnavailable ? (
                ...
                <p className="recon-quiet-note">
                    Nothing in the Route Library yet.
                </p>
            ) : (
                <ul className="recon-track-list">
...
function TrackRow({
    ...
    const badgeClass =
        entry.badge === "Recorded"
            ? "recon-badge-recorded"
            : "recon-badge-preview";
    return (
        <button
            type="button"
        ...
        >
            <span className="recon-row-top">
                ...
                <span className={`recon-badge ${badgeClass}`}>
                    {entry.badge}
                </span>
            </span>
