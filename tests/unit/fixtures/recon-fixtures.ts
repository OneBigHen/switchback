...
export function makePlannedRoute(
...
export function makeRecordedRidePoints(): RecordedRidePoint[] {
  return [
    makeRidePoint([0, 0], iso(TEST_RIDE_START_MS), {
      speedMph: 10,
      altitudeMeters: 100,
    }),
    makeRidePoint([0, 0.001], iso(TEST_RIDE_START_MS + 60_000), {
      speedMph: 20,
      altitudeMeters: 140,
    }),
    makeRidePoint([0, 0.002], iso(TEST_RIDE_START_MS + 120_000), {
      speedMph: 30,
      altitudeMeters: 120,
    }),
  ];
...
export function makeRecordedRide(
  overrides: Partial<RecordedRide> = {},
): RecordedRide {
